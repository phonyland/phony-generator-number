...
test('digit() method returns an integer value', function (): void {
    $value = 🙃()->number->digit();

    expect($value)->toBeInt();
});

test('digit() method returns a digit', function (): void {
    $value = 🙃()->number->digit();
...
test('digit() method returns a digit for the given $base', function (): void {
